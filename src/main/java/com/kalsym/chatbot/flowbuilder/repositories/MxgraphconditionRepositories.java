 ...
 * @author user
 */
public interface MxgraphconditionRepositories extends MongoRepository<Mxgraphcondition, String> {
     ...
     */
   @Query("{'flowId' : ?0}")
    public List <Mxgraphcondition> getMxByFlowId(
    ...
    public List <Mxgraphcondition> deleteConditionByFlowId(String flowId);
   ...
   @Query("{'flowId' : ?0, 'mxId' : ?1}")
    public Mxgraphcondition findByMxId(
            @Param("flowId") String flowId,
   ...
   public List<Mxgraphcondition> findByUserObjectMxId(
            @Param("flowId") String flowId,
